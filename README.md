#### This tutorial is now deprecated, please refer to <https://developer.dji.com/mobile-sdk/documentation/android-tutorials/P4MissionsDemo.html> in DJI Developer Website.
...
Now that you know the details of the two new missions of Phantom 4, we can start working on the application. In our previous tutorial [**Creating a Camera Application**](https://github.com/DJI-Mobile-SDK/Android-FPVDemo), you have learned how to import the DJI Android SDK into your Android Studio project and activate your application. If you haven't read that previously, please take a look at it. Once you've done that, let's create the project.
...
![PointingTestActivity](./Images/tapFlyActivityUI.png)
...
![PointingTestActivity](./Images/activeTrackActivityUI.png)
...
![p4MissionsUIDemo](./Images/p4MissionsUIDemo.gif)
...
![tapFlyMissionCoordinate](./Images/android_tapFlyMissionCoordinate.png)
...
![tapFlyMissionHoriGif](./Images/tapFlyLeftRightAnimate.gif)
...
![tapFlyMissionHoriGif](./Images/tapFlyAnimate.gif)
...
![ActiveTrackMissionGif](./Images/activeTrackAnimate.gif)
...
**4.** Now you can connect your Android which is running the demo application to the remote controller, and start to test the **TapFly** and **ActiveTrack** missions on the simulator.  

By the way, you can use Wireless Android Debug Bridge (adb) to debug the app using Android Studio when your android device is connecting to the remote controller. If you are not familiar with Android Debug Bridge, please check this [link](http://developer.android.com/tools/help/adb.html) for details.
